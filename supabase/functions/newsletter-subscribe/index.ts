        ...
        <div style="margin:0;padding:24px 0;background:#f4f4f5;">
          <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;font-family:Helvetica,Arial,sans-serif;">
            ...
            <div style="padding:28px 24px;color:#1a1a1a;">
              ...
              <p style="margin:0 0 16px;color:#444;line-height:1.6;">Kiitos, että liityit Lucky Discs -uutiskirjeen tilaajaksi! Saat ensimmäisten joukossa tiedon:</p>
              <ul style="color:#444;line-height:1.9;padding-left:20px;margin:0 0 20px;">
                ...
                <li>vinkeistä kiekonvalintaan ja heittotekniikkaan</li>
              </ul>
            ...
            <div style="background:#0a0a0a;padding:20px 24px;text-align:center;">
              ...
              <div style="color:#9ca3af;font-size:12px;line-height:1.7;">Y-tunnus 3368925-4<br>asiakaspalvelu@luckydiscs.fi &middot; <a href="https://www.luckydiscs.fi" style="color:#E2AD28;text-decoration:none;">luckydiscs.fi</a></div>
